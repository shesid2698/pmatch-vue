<template>
  <div class="buyLogBox relative" @click="toggleBuyLog" v-show="userToken && memberId">
    <div class="flex items-center">
      <div class="flex items-center">
        <img class="w-25px" src="/images/buyLogIcon.png" alt="購買紀錄icon" />
      </div>
      <div class="flex items-center ms-3">
        <span> 購買紀錄 </span>
      </div>
    </div>
    <div v-show="buyLogOpen" class="buyLogDetailBox absolute top-100% right-0 color-#f72585">
      <div class="buyLogDetail">
        <NuxtLink class="decoration-none color-#f72585" v-for="(item, index) in buyLog" :key="index"
