        ...
        <div class="pb-7rem">
            <div class="max-w-1110px m-auto ps-5 pe-5 relative z-2">
                <div class="flex md-flex-nowrap flex-wrap justify-center">
                    <div v-for="(item, index) in programList"
                         :key="index"
                        ...
                        <div>
                            ...
                            <div class="flex justify-center">
                                <div>
                                    <div class="flex mb-1rem lg-px-1.5rem"
            ...
            <div class="max-w-1110px m-auto ps-5 pe-5 relative z-2">
                ...
                <div class="planTable">
                    ...
                    <div class="color-#fff planBox">
                        <div v-for="(row, rowIndex) in planList"
                             :key="rowIndex"
                            ...
                            <!-- 右側內容 -->
                            <div class="flex">
                                <div v-for="(item, itemIndex) in row.values"
                                     :key="itemIndex"
            ...
            <div class="max-w-1110px m-auto ps-5 pe-5 relative z-2">
                ...
                <div class="qaBox mb-3"
                    ...
                    <div class="w-100% p-1rem md-p-1.5rem">
                        ...
                        <div v-show="answerShow === index && item.Answer !== ''"
                             v-html="item.Content"
