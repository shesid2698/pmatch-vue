  ...
  <div class="storeBac">
    ...
    <div class="pb-7rem">
      <div class="max-w-1110px m-auto ps-5 pe-5 relative z-2">
        <div class="flex md-flex-nowrap flex-wrap justify-center">
          <div v-for="(item, index) in programList" :key="index" :class="`${item.className}`"
            ...
            <div>
              ...
              <div class="flex justify-center pb-2rem mb-2rem programPriceBox">
                <div>
                  <span>NT</span>
              ...
              <div class="flex justify-center">
                <div>
                  <div class="flex mb-1rem lg-px-1.5rem" v-for="it in item.detail">
                    <div class="me-1.5rem">
                      <img class="w-20px" src="/images/icon-check-01.png" alt="" />
                    </div>
                    <div>
                      <span>{{ it }}</span>
                    </div>
        ...
        <div class="planTable">
          <div class="color-#fff flex justify-end min-w-600px">
            <div class="flex py-3">
              ...
              <div class="px-1rem w-80px text-center color-#43edff">
                專業版
              </div>
          ...
          <div class="color-#fff planBox">
            <div v-for="(row, rowIndex) in planList" :key="rowIndex" class="flex justify-between py-4 planCol">
              <!-- 左側描述文字 -->
              ...
              <!-- 右側內容 -->
              <div class="flex">
                <div v-for="(item, itemIndex) in row.values" :key="itemIndex"
                  class="flex justify-center items-center px-1rem w-80px" :class="item.colorClass">
                  <template v-if="item.type === 'image'">
                    <img :src="item.src" :alt="item.alt" class="w-20px" />
                  </template>
                  <template v-else>
                    <span class="fw-600">{{
                      item.value
    ...
    <div class="pb-7rem">
      <div class="max-w-1110px m-auto ps-5 pe-5 relative z-2">
        ...
        <div class="qaBox mb-3" v-for="(item, index) in qaList" :key="index" @click="answerBoxToggle(index)">
          <div class="w-100% p-1rem md-p-1.5rem">
            <div class="w-100% flex justify-between items-center">
              <div class="font-size-20px color-#43edff flex items-center">
            ...
            <div v-show="answerShow === index && item.Answer !== ''" v-html="item.Content"
              class="answerBox font-size-20px color-#fff"></div>
          </div>
        </div>
      </div>
    </div>
