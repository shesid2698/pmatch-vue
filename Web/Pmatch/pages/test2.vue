<template>
  <div class="mt-100px">
    <button @click="dialogVisible = true">出現吧</button>
    <el-dialog v-model="dialogVisible" width="500" align-center :show-close="false" :close-on-click-modal="false">
      ...
      <div class="px-5 pb-2 max-h-400px scrollbar"
        @scroll="e => dialogVisible = e.target.scrollHeight - e.target.scrollTop === e.target.clientHeight ? false : true">
        【蒐集個人資料告知事項】
        <br>
        <br>
