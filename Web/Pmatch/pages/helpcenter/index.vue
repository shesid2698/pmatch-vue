<template>
    ...
    <div class="dot1">
        <img src="/images/bg-dot03.png"
             width="100%"
             alt="">
    </div>
    <div class="dot2">
        <img src="/images/bg-dot04.png"
             width="100%"
             alt="">
    </div>
    <div class="dot3">
    ...
    <div class="max-w-1110px m-auto pt-80px ps-5 pe-5 relative z-2">
        ...
        <div class="m-y-0 m-x-auto w-fit"><img src="/images/img-Q&A.png"
                 width="110"
                 alt=""></div>
            ...
            <div class="w-100% text-center md:w-30% pl-0 md:pl-20px">
                <div class="relative searchBoxContainer">
                    ...
                    <span class="absolute top-50% transform-translate-y-[-45%] right-20px cursor-pointer"
                          @click="GetSearchQuery"><img src="/images/searchIcon.png"
                             width="30"
                             alt=""></span>
                </div>
            </div>
