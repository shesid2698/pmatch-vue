    ...
    <div class="login-card w-100% md:w-378px">
      <form action="" method="post">
        ...
        <div class="mt-15px">
          ...
          <div class="relative">
            <input v-model="password" type="password" required ref="i_password"
        ...
        <div class="mt-15px">
          <div class="flex">
            ...
            <div class="w-10px"></div>
            <div class="flex-1">
              <button @click="login" type="button" :disabled="hasToken == false"
        ...
        <ClientOnly>
          <GoogleLogin :callback="GoogleCallback" popup-type="TOKEN">
            <button class="otherLoginBtn mx-3">
              <img class="w-30px" src="/images/iconGoogle.png" alt="GOOGLE帳號登入" />
            </button>
          </GoogleLogin>
        </ClientOnly>
        <button class="otherLoginBtn mx-3" @click="thirdPartyLogin.LineLogin">
          <img class="w-30px" src="/images/iconLine.png" alt="LINE帳號登入" />
        </button>
        <button @click="loginFb" class="otherLoginBtn mx-3">
          <img class="w-30px" src="/images/iconFB.png" alt="FB帳號登入" />
        </button>
      </div>
    </div>
  </div>
