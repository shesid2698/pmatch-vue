    ...
    <div class="flex-1 md:pl-20px">
      ...
      <div>
        ...
        <el-table :data="tableData" :default-sort="{ prop: 'Time', order: 'descending' }" style="width: 100%"
          ...
          <el-table-column prop="GamePlat" label="營運平台" />
          <el-table-column prop="GameRole" label="媒合商" />
          <el-table-column prop="Status" label="委託狀態" />
          <el-table-column prop="Amount" label="數量" />
          <el-table-column prop="Gamecurrency" label="單位" />
