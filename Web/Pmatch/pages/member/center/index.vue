            ...
            <div class="text-20px flex justify-center">
                <div>
                    ...
                    <form action=""
                        ...
                        <div class="mt-15px">
                            <button class="bg-[#e93470] cursor-pointer text-white text-16px h-38px w-100% rounded-[5px] outline-none border-none hover:bg-[#bb2d3b] transition duration-300">
                                提交
                            </button>
                        </div>
                    </form>
