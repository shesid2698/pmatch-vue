                ...
                <div>
                    ...
                    <form action="" @submit="checkForm">
                        ...
                        <div class="mt-15px">
                            ...
                            >
                                <span
                                    class="absolute top-50% transform transform translate-y--1/2 left-10px text-black"
                                    >/</span
                                >
                                <input
                                    type="text"
...
const checkForm = async (event) => {
    ...
    if (
        ...
        allAddress =
            selectedCity.value + selectedRegion.value + addressDetail.value;
...
onMounted(async () => {
    ...
    if (cities.value != null && cities.value != undefined) {
        ...
        if (selectedCity.value !== "" && selectedRegion.value != "") {
            theUser[0].Address = theUser[0].Address.replace(
                selectedCity.value,
                ""
            );
            theUser[0].Address = theUser[0].Address.replace(
