<template>
  <Head>
    ...
    <Meta name="description" content="Pmatch遊戲道具交易平台 – 博奕遊戲安心交易的第一選擇，Pmatch為你嚴選商家，用合約保障你的權益，杜絕詐騙，防護交易安全" />
    <Meta property="og:description" content="Pmatch遊戲道具交易平台 – 博奕遊戲安心交易的第一選擇，Pmatch為你嚴選商家，用合約保障你的權益，杜絕詐騙，防護交易安全" />
  </Head>
      ...
      <div class="text-20px flex justify-center">
        <div class="w-335px md:w-370px">
          <div class="flex flex-items-center mb-20px">
            <span class="w-25px h-20px inline-block bg-#1a6db4 mr-8px mt-3px"></span>綁定社群帳號
          </div>
          <div>
          ...
          <div>
            <div class="socialBox flex justify-between w-100%">
              ...
              <div class="flex items-center">
                <ClientOnly>
                  <GoogleLogin :callback="bindGoogle" popup-type="TOKEN">
                    <button class="bindBtn" :class="{
            ...
            <div class="socialBox flex justify-between w-100%">
              ...
              <div class="flex items-center">
                <button class="bindBtn" :class="{
                  'bg-#e93470 color-#fff cursor-pointer':
                    isPlatformBound(2),
                }" :disabled="!isPlatformBound(2)" @click="bindFb">
                  {{
                    isPlatformBound(2)
                      ? "進行綁定"
                      : "已綁定"
            ...
            <div class="socialBox flex justify-between w-100%">
              ...
              <div class="flex items-center">
                <button class="bindBtn" :class="{
                  'bg-#e93470 color-#fff cursor-pointer':
                    isPlatformBound(3),
                }" :disabled="!isPlatformBound(3)" @click="bindLine">
                  {{
                    isPlatformBound(3)
                      ? "進行綁定"
                      : "已綁定"
