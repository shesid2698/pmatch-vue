<template>
    <div>
        ...
        <div class="w-full bg-#fff relative mt-5rem">
            ...
            <div
                class="mt-5rem max-w-1110px m-auto lg-ps-0 ps-3 lg-pe-0 pe-3 relative z-11"
            >
                <div class="flex justify-center">
...
.rightItem {
    transform: translateX(292.407px) scale(0.83) perspective(1000px)
        rotateY(-40deg) !important;
}
.leftItem {
    transform: translateX(-22.9075px) scale(0.83) perspective(1000px)
        rotateY(40deg) !important;
}
