        ...
        <div class="lg-flex">
          <div class="w-100% lg-w-50% lg-me-1rem">
            <div class="flex mb-3 pb-2rem items-center">
              <div v-if="storesItem != null" class="imgContainer flex justify-center items-center">
                <div v-show="storesItem.IMGFiles" class="flex items-center">
                  <img :src="`${assetsUrl}${storesItem.IMGFiles}`" :alt="storesItem.Name" class="imgContainerItem" />
                </div>
                <div v-show="!storesItem.IMGFiles" class="flex items-center">
                  <span>{{ storesItem.Name }}</span>
                </div>
              </div>
              <h2 class="storeTitle font-size-36px" v-if="storesItem">
                {{ storesItem.Name }}
              </h2>
            </div>
                ...
                <div class="flex items-center justify-center w-100%">
                  <div class="platformBox">
                    <div class="platformContent flex justify-center items-center">
                      <div>
                        <img v-show="getImgFile(item)" class="platformImg w-100%" :src="`${assetsUrl}${getImgFile(
                          item
                        )}`" :alt="item" />
                      </div>
