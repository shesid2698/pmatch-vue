      ...
      <div class="w-370px">
        ...
        <form action="#" @submit="SubmitForm">
          <div class="mt-15px">
            ...
            <div class="flex">
              <div class="w-68% relative">
                <input type="text" required v-model="phone" :disabled="mobileVerify === true"
              ...
              <div class="w-2%"></div>
              <div class="w-30%">
                <button v-if="mobileVerify !== true" onclick="event.preventDefault();" @click="openMobileDialog"
          ...
          <div class="mt-15px">
            ...
            <div class="flex">
              <div class="w-60% relative">
                <input type="email" v-model="email" :disabled="emailVerify === true" @input="validEmailPattern"
              ...
              <div class="w-2%"></div>
              <div class="w-38%">
                <button v-if="emailVerify !== true" onclick="event.preventDefault();" @click="emailTableVisible = true"
          ...
          <div class="mt-15px">
            ...
            <div class="flex">
              <div class="w-49%">
                <select @change="GetRegions" v-model="selectedCity"
                  class="box-border p-y-1.5 p-x-3 text-base w-100% outline-none rounded-1 border-solid border-1 border-[#ced4da] focus:outline-5 focus:outline-[#c2d9fe] focus:outline-offset-0 focus:border-[#A1C0E3] transition duration-200">
                ...
                <GoogleLogin :callback="GoogleCallback" popup-type="TOKEN">
                  <button class="otherLoginBtn mx-3" type="button"
                    ...
                    <a :title="googleBind"><img class="w-25px"
                        ...
                        src="/images/iconGoogle.png" alt="GOOGLE帳號登入" /></a>
                  </button>
                </GoogleLogin>

              </ClientOnly>

              <button class="otherLoginBtn mx-3" type="button" :disabled="thirdPartyPlatform.some(x => x.Category == 3)"
                @click="thirdPartyLogin.LineLogin">
                <a :title="lineBind">
                  <img class="w-25px" src="/images/iconLine.png" alt="LINE帳號登入"
                    :class="{ 'filterLight': !!thirdPartyPlatform.some(x => x.Category === 3) }" />
                </a>

              </button>
              <button class="otherLoginBtn mx-3" type="button" :disabled="thirdPartyPlatform.some(x => x.Category == 2)"
                @click="loginFb">
                <a :title="fbBind">
                  <img class="w-25px" src="/images/iconFB.png" alt="FB帳號登入"
          ...
          <div class="mt-15px">
            <div class="flex">
              ...
              <div>
                <NuxtLink to="/company/privacy" target="_blank"
            ...
            <div class="flex">
              ...
              <div>
                <NuxtLink to="/company/service" target="_blank"
