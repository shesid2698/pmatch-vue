    ...
    <div class="w-68.75% flex flex-col flex-items-center">
      <div class="w-370px">
        ...
        <div class="flex justify-center mt-70px">
          <div class="rounded-full w-76px h-76px bg-[#a7cf4a] text-center content-center text-50px text-white">
            <i class="fa-solid fa-check"></i>
          </div>
        </div>
        <div class="flex flex-items-center mt-15px">
          <div class="w-15% leading-[25px] h-25px text-22px text-[#0d6efd]">
            帳號
          </div>
        ...
        <div class="mt-30px">
          <NuxtLink to="/member/login"><button
