<template>
  <div>
    ...
    <div class="max-w-1110px m-auto ps-5 pe-5 m-t-100px">
      <div class="flex flex-wrap">
        <div class="block md-flex flex-wrap gameOutside w-100%">
          <div class="w-auto md:w-900px m-x-auto rounded-10px overflow-hidden m-b-30px">
            <ElCarousel class="h-auto" :interval="3000" arrow="always">
              <ElCarouselItem class="h-auto" v-for="(item, index) in bannerDownList" :key="index">
          ...
          <div class="gameBox flex" v-for="(item, index) in gameList" :key="index"
        ...
        <div class="m-x-auto pt-3 pb-3">
          <div class="moreGameBtnBox" :class="gameList.length === allGameList.length ? `moreGameBtnBoxDisabled` : ``">
            <span @click="AddGames" class="moreGameBtn color-#fff font-size-22px decoration-none"
    ...
    <div>
      ...
      <div class="relative" id="cardContainer">
        <div class="tips" :class="thePosition <= 20 ? 'tipsMove' : ''"
        ...
        <div class="max-w-1110px m-auto ps-5 pe-5 p-t-100px"
          ...
          <div class="flex flex-wrap w-100%">
            <div v-for="(item) in companies" :key="item.Id" class="w-100% md:w-1/3 pr-0 md:pr-15px box-border">
